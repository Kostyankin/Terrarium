...
#define DHTPIN 5
#define Relay1_PIN 6 //пин управления реле вентилятора
#define Relay2_PIN 7 //пин управления реле лампой
//----------------------------------------------------------------------------------------------------------------
...
#define TempFanOff 25 //температура выключения вентилятора
#define TempFanOn 26 //температура включения вентилятора
